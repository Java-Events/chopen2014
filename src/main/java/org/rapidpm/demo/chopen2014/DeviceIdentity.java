...
public class DeviceIdentity {
  ...
  public String toString() {
    final StringBuilder sb = new StringBuilder("DeviceIdentity{");
    sb.append("uid='").append(uid).append('\'');
    sb.append(", connectedUid='").append(connectedUid).append('\'');
    sb.append(", position=").append(position);
    sb.append(", hardwareVersion=").append(Arrays.toString(hardwareVersion));
    sb.append(", firmwareVersion=").append(Arrays.toString(firmwareVersion));
    sb.append(", deviceIdentifier=").append(deviceIdentifier);
    sb.append('}');
    return sb.toString();
  }
